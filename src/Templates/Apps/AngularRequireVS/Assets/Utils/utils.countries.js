(function (requirejs) { 
    require(['utils'], function (u) {
        u.createNS(['Data.countryCodes', 'Data.getCountryInfo']);
        ...
        var countryCodes = countryCodesList.map(function (e) {
            var currency_alphabetic_code = e.currency_alphabetic_code == '' ? e.currency_name : e.currency_alphabetic_code,
                currency_symbols = u.Data.getCurrencyInfo(currency_alphabetic_code)
            ...
            var Allcodes = {
                ...
                ISO3166: {
                    alpha2: e["ISO3166-1-Alpha-2"],
                    alpha3: e["ISO3166-1-Alpha-3"],
                ...
                currency: {
                    alphabetic_code: currency_alphabetic_code,
                    country_name: e.currency_country_name,
                    minor_unit: e.currency_minor_unit,
                    name: e.currency_name,
                    numeric_code: e.currency_numeric_code,
                    symbol: currency_symbols.symbol,
                    symbol_native: currency_symbols.symbol_native
        ...
        var countriesObj = countryCodes.reduce(function (obj, k) {
            var key = k.ISO3166.alpha2,
                value = {
                    sports: k.sports,
                    ISO3166: k.ISO3166,
                    currency: k.currency,
        ...
        u.Data.countryCodes = countryCodes;
        
        u.Data.getCountryInfo = function (alpha2Code) {
            
            var e = alpha2Code ? alpha2Code.toUpperCase() : undefined;
            
            return e ? countriesObj.hasOwnProperty(e) ? countriesObj[e] : 'no such code' : countriesObj;

        }
        
        //TEST    
        console.log(u.Data.getCountryInfo('GB'));
